...
class PurchaseTest extends TestCase
{
    ...
    {
        $product = Product::create(['upc' => '123', 'product_name' => 'Item', 'price' => 150, 'last_confirmed' => now()]);
    ...
    {
        $product = Product::create(['upc' => '123', 'product_name' => 'Item', 'price' => 100, 'last_confirmed' => now()]);
        $otherProduct = Product::create(['upc' => '456', 'product_name' => 'Other item', 'price' => 999, 'last_confirmed' => now()]);
    ...
    {
        $original = Product::create(['upc' => '111', 'product_name' => 'Squash 1.75L', 'price' => 150, 'last_confirmed' => now()]);
        ...
        $this->assertSame([150, 160], $history->pluck('price')->map(fn ($price) => $price->minorUnits)->all());
        $this->assertTrue($history->first()['date']->isSameDay(Carbon::parse('2026-01-01')));
    }
}
